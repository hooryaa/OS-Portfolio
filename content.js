...
const CONTENT = {
  ...
  profile: {
    ...
    firstName: "Hooria",
    initials: "HA",
    role: "Software Engineer | Aspiring Data Engineer | Data Analyst",
    tagline: "Software Engineering graduate building data-driven applications, ETL pipelines, analytics platforms, and AI-powered tooling.",
    subrole: "Data Engineering · Analytics · Business Intelligence",
    summary: "Software Engineering graduate with hands-on experience building data-driven applications, ETL pipelines, analytics platforms, Power BI dashboards, automation tools, and full-stack solutions using Python, SQL, PostgreSQL, Power BI, TypeScript, Pandas, and NumPy. Experienced in data extraction, transformation, validation, visualization, API integration, and relational database design. Developed projects spanning data engineering, business intelligence, analytics, workflow automation, and software development. Seeking opportunities in Data Engineering, Data Analytics, and Business Intelligence.",
    location: "Lahore, Pakistan",
    timezone: "GMT+5 (PKT)",
    availability: "Seeking opportunities in Data Engineering, Data Analytics, and Business Intelligence",
  ...
  projects: [
    ...
    },
    {
      ...
      glyph: "▥",
      summary: "A suite of Power BI dashboards with 15+ KPIs, dimensional data modeling, and optimized DAX measures.",
